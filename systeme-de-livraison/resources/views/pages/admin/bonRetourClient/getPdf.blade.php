      ...
      <td style="position: relative">
        <div style=" border-style: solid; margin-bottom: 10px; padding: 10px;width:500px;height:100px">
          <div class="colis grid-item--full">
              <strong >Bon de retour pour client:</strong>
              <span>{{ $bon->id_BRC }}</span>
          </div>
          <div class="colis grid-item--full">
              <strong >Date: </strong>
  ...
  <table class="table">
    ...
    @foreach($colis as $i=>$item)
      ...
      <tr style="height:18.65pt; -aw-height-rule:exactly">
          ...
          <td class="td"> <p style="font-size:8pt"><span style="font-family:Calibri"> {{ $item->BRZ->created_at }} </</span></p>
          </td>
