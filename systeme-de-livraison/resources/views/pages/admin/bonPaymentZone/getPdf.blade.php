      ...
      <td style="position: relative">
        <div style=" border-style: solid; margin-bottom: 10px; padding: 10px;width:300px;height:100px">
          <div class="colis grid-item--full">
              <strong >Bon de payment pour Zone:</strong>
  ...
  <table class="table">
    ...
    @foreach($colis as $i=>$item)
      ...
      <tr style="height:18.65pt; -aw-height-rule:exactly">
          ...
          <td class="td"> <p style="font-size:8pt"><span style="font-family:Calibri"> {{ $item->bonPaymentLivreur->livreur->fraislivraison }}  Dhs</span></p>
          </td>
          <td class="td"> <p style="font-size:8pt"><span style="font-family:Calibri"> {{ $item->prix - $item->bonPaymentLivreur->livreur->fraislivraison }}  Dhs</span></p>
          </td>
      </tr>
      ...
      <tr style="height:18.65pt; -aw-height-rule:exactly">
          ...
          <td class="td" ><p style="font-size:8pt"><span style="font-family:Calibri"> {{ $item->prix - $item->bonPaymentLivreur->livreur->fraislivraison }} </span></p></td>
