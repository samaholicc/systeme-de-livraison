            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                ...
                <tbody class="fw-semibold text-gray-600">
                            ...
                            <td>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-250px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a class="btn" onclick="openModal('{{ $item->id_BD }}')"
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_new_target"><i
                                                class="fa fa-eye"></i>Details du bon</a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a class="btn"
                                            href="{{ route('bon.distribution.exportColis', $item->id_BD) }}"><i
                                                class="far fa-file-excel"></i>Exporter les colis</a>
                                    </div>
                                    @if ($item->status != 'Recu')
                                        <div class="menu-item px-3">
                                            <form action="{{ route('bon.distribution.recu', $item->id_BD) }}"
                                                method="post">
                                                @csrf
                                    ...
                                    @else
                                        <div class="menu-item px-3">
                                            <form action="{{ route('bon.distribution.nonrecu', $item->id_BD) }}"
                                                method="post">
                                                @csrf
                                                <button type="submit"class="btn">
                  ...
                  <div class="menu-item  text-hover-danger px-3">        
                    <a  href="{{ route('bon.distribution.destroy',$item->id_BD) }}" class="btn">
                ...
                @endif --}}
                                    @if ($item->colis->count() == 0)
                                        <div class="menu-item text-hover-danger px-3">
                                            <form action="{{ route('bon.distribution.destroy', $item->id_BD) }}"
                                                method="POST"
                                    ...
                                    <div class="menu-item px-3">
                                        <a class="btn" href="{{ route('bon.distribution.getPdf', $item->id_BD) }}"><i
