                        ...
                        <tr>
                            <td>
                                <div class="">
                                    <div class="ms-5">
                                        <a href=""
                                            class="text-gray-800 text-hover-primary fs-5 fw-bold"data-kt-ecommerce-product-filter="code">{{ $item->reference }}</a>
                                    </div>
                                </div>
                            </td>
                            <td class="pe-0">
                            ...
                            <td>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-250px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a class="btn" onclick="openModal('{{ $item->id_BPL }}')"
...
@endif
    ...
    <script>
        ...
        function openModal(id) {
            ...
            let bons = @json($bons);
            console.log(bons);
            let BE = bons.find(ele => ele.id_BPL == id)
            console.log(BE);
            let text = ''
            text = `<div class="row">
    <div class="dn-inv-infos-box col-6">
      <b>Bon d envoie : </b> ${BE.id_BPL}<br>
