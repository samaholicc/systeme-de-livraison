...
@section('content')
    <div class="container">
        <div class="w-lg-100 p-10">
            <form action="{{ route('admin.livreur.updatePass', $livreur->id_Liv) }}" method="post" class="form w-100 row"
                enctype="multipart/form-data" id="kt_sign_up_form">
                @csrf
                @method('PUT')
                <div class="text-center mb-11">
                    <h1 class="text-dark fw-bolder mb-3">Edit Mot de Passe de livreur</h1>
                </div>
