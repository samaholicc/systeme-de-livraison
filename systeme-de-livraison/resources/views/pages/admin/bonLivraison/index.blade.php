          ...
          <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
            <div class="row">
              <div class="dn-inv-infos-box col-6">
                <b>Bon d envoie : </b> BL-100524-013690-55<br>
                <b>Date :</b> 2024-05-10 14:17<br>
                <b>Colis :</b> 1<br>
                <b>Total :</b> 200 Dhs
              </div>
            </div>
            ...
            <div class="table-responsive">
              <table class="table table-striped table-bordered table-sm   no-wrap v-middle mb-0">
              <thead>
              ...
              <tr class="dn-inv-table-body">
                      <td><b>1</b></td>
                      <td class="td-nowrap">123456789</td>
                      <td class="td-nowrap">0623451289</td>
                      <td class="td-nowrap">Rabat</td>
                      <td>
                      <b>Adresse : </b> HAY RIYAD<br><b>Commentaire : </b> TAL 2<br>
                      </td>
                <td class="parcel-status td-nowrap"><span class="badge" style="color:#835476; border:1px solid #835476">en livraison</span></td>
                      <td class="td-nowrap">200 Dhs</td>
                  </tr>
                                ...
                                <div class="">
                                    <div class="ms-5">
                                        <a href="" class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                            data-kt-ecommerce-product-filter="code">{{ $item->id_BL }}</a>
                                    </div>
                                </div>
                            </td>
                            <td class="pe-0">
                                <span class="fw-bold"
                                    data-kt-ecommerce-product-filter="nomcomplet">{{ $item->client_nomcomplet }}</span>
                            </td>
                            <td class="pe-0">
                            ...
                            <td>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-250px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a class="btn" onclick="openModal('{{ $item->id_BL }}')"
                                    ...
                                    @if ($item->colis->count() == 0)
  <div class="menu-item text-hover-danger px-3">
    <form action="{{ route('bon.livraison.destroy', $item->id_BL) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this item?');">
      @csrf
      @method('DELETE')
      <button type="submit" class="btn">
        <i class="fa fa-trash"></i> Delete
...
@endif
                                    ...
                                    <div class="menu-item px-3">
                                        <a class="btn" href="{{ route('bon.livraison.getPdf', $item->id_BL) }}"><i
